...
enctoken = 'VTdHW/iIGoWXKQW9sA1WdH+Op0ahRbPN6XKtaWaloNasHNNkPyQKfb6DgJvqTM8n1yss0rSaF2xmNAqSCfjbMKEP58jHT1jaxIxajHPj1FTFo0k3J88gLQ==' # input("Enter enc token \n\n")
...
def case1():
    print(kite.margins(), '\n')
    print(kite.orders(), '\n')
    order = pd.DataFrame(kite.orders())
    print("order id is --->",order['order_id'])
    print(kite.positions(), '\n')

def case2():
    # Initial parameters
    entry_price = 0.00  # The price at which you entered the position
    trailing_percent = 0.05  # 2% trailing stop
...
def case6():
    # Initial parameters
    trailing_percent = 0.5  # 2% trailing stop
